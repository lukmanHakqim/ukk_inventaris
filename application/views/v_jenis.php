...
<body>
    ...
    <div class="wrapper">
        <h1 style="font-size:20pt">Data Jenis</h1>

        <br />
        <button class="btn btn-success" onclick="add_jenis()"><i class="glyphicon glyphicon-plus"></i> Add jenis</button>
...
function edit_jenis(id_jenis)
{
    ...
    $.ajax({
        url : "<?= site_url('jenis/ajax_edit/')?>/" + id_jenis,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?= site_url('jenis/ajax_add')?>";
    } else {
        url = "<?= site_url('jenis/ajax_update')?>";
    }
...
function delete_jenis(id_jenis)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?= site_url('jenis/ajax_delete')?>/"+id_jenis,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Jenis Form</h3>
            </div>
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Id Jenis</label>
                            <div class="col-md-9">
                                <input name="id_jenis" placeholder="Id Jenis" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="nama_jenis" placeholder="Nama Jenis" class="form-control">
                                <span class="help-block"></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="kode_jenis" placeholder="Kode Jenis" class="form-control">
                                <span class="help-block"></span>
                            </div>
                        </div>
