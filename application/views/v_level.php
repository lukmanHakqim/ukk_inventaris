...
<body>
    ...
    <div class="wrapper">
        <h1 style="font-size:20pt">Data Level</h1>
...
function add_level()
{
    ...
    $('.modal-title').text('Add Level'); // Set Title to Bootstrap modal title
}
 
function edit_level(id_level)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?= site_url('level/ajax_edit/')?>/" + id_level,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?= site_url('level/ajax_add')?>";
    } else {
        url = "<?= site_url('level/ajax_update')?>";
    }
...
function delete_level(id_level)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?= site_url('level/ajax_delete')?>/"+id_level,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                ...
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Id Level</label>
                            <div class="col-md-9">
                                <input name="id_level" placeholder="Id Level" class="form-control" type="text">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="nama_level" placeholder="Nama Level" class="form-control">
                                <span class="help-block"></span>
                            </div>
                        </div>
