...
<body>
    ...
    <div class="wrapper">
        <h1 style="font-size:20pt">Data Pegawai</h1>

        <br />
        <button class="btn btn-success" onclick="add_pegawai()"><i class="glyphicon glyphicon-plus"></i> Add Pegawai</button>
...
function edit_pegawai(id_pegawai)
{
    ...
    $.ajax({
        url : "<?= site_url('pegawai/ajax_edit/')?>/" + id_pegawai,
        type: "GET",
        dataType: "JSON",
...
function delete_pegawai(id_pegawai)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?= site_url('pegawai/ajax_delete')?>/"+id_pegawai,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
